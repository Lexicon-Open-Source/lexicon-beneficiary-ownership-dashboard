...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'crawler.base_url' => 'string',
            'crawler.timeout' => 'integer',
            ...
            'filesystems.links./Users/adryanev/Code/lexicon-bo/lexicon-beneficiary-ownership-dashboard/public/storage' => 'string',
...
'cache.stores.octane.driver','cache.prefix','crawler.base_url','crawler.timeout','database.default',
...
'database.redis.cache.username','database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','filament.broadcasting',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Users/adryanev/Code/lexicon-bo/lexicon-beneficiary-ownership-dashboard/public/storage','fortify.guard',
...
'jetstream.guard','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'blade-icons.components.default','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'filament.exports.download','filament.imports.failed-rows.download','filament.dashboard.auth.login','filament.dashboard.auth.password-reset.request','filament.dashboard.auth.password-reset.reset',
'filament.dashboard.auth.logout','filament.dashboard.auth.email-verification.prompt','filament.dashboard.auth.email-verification.verify','filament.dashboard.pages.dashboard','filament.dashboard.pages.api-tokens',
'filament.dashboard.pages.crawler','filament.dashboard.pages.edit-profile','filament.dashboard.pages.scraper','filament.dashboard.resources.corruption-cases.index','filament.dashboard.resources.corruption-cases.create',
'filament.dashboard.resources.corruption-cases.edit','filament.dashboard.resources.corruption-cases.view','filament.dashboard.resources.data-sources.index','filament.dashboard.resources.data-sources.create','filament.dashboard.resources.data-sources.edit',
'filament.dashboard.resources.draft-cases.index','filament.dashboard.resources.draft-cases.create','filament.dashboard.resources.draft-cases.view','filament.dashboard.resources.draft-cases.edit','login',
...
'livewire.upload-file','livewire.preview-file','login',
'register','dashboard','team-invitations.accept','livewire.update',);
        registerArgumentsSet('views', 
'api.api-token-manager','api.index','components.action-message','components.action-section','components.application-logo',
...
'components.label','components.layouts.app','components.modal','components.nav-link','components.responsive-nav-link',
...
'components.welcome','emails.team-invitation','filament.pages.api-tokens','filament.pages.crawler','filament.pages.create-team',
'filament.pages.edit-profile','filament.pages.edit-team','filament.pages.scraper','layouts.app','layouts.guest',
...
'profile.update-password-form','profile.update-profile-information-form','terms','welcome','filament-actions::badge-action',
...
'REDIS_PASSWORD','REDIS_PORT','ELASTIC_SEARCH_HOST','ELASTIC_SEARCH_API_PORT','ELASTIC_SEARCH_TRANSPORT_PORT',
'ELASTIC_SEARCH_SCHEME','ELASTIC_SEARCH_USER','ELASTIC_SEARCH_PASS','MAIL_MAILER','MAIL_HOST',
